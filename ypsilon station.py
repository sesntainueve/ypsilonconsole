...
Communicación = ["COMUNICACIÓN", "Comunicación", "comunicación"]
Mapa = ["MAPA", "Mapa", "mapa"]
Estado = ["ESTADO", "Estado", "estado"]
Atrás = ["ATRÁS", "Atrás", "atrás"]
Más = ["MÁS", "Más", "más"]
Encender = ["on", "ON", "On", "ENABLE", "Enable", "enable", "ENCENDER", "Encender", "encender", "ACTIVAR", "Activar", "activar"]
Apagar = ["off", "OFF", "Off", "DISABLE", "Disable", "disable", "APAGAR", "Apagar", "apagar"]
System = ["System", "SYSTEM", "system"]
Escotillas = ["Escotillas", "escotillas", "ESCOTILLAS"]
...
tA = ["UNLOCK MINESHAFT", "unlock mineshaft", "Unlock Mineshaft", "Unlock mineshaft", "UNLOCK MINE", "unlock mine", "Unlock Mine", "Unlock mine", "MINE UNLOCK"]
